...
export const Perspective = ({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="[transform-style:preserve-3d] w-full flex justify-center">
        <div
          ref={cardRef}
          className="max-w-[480px] p-10 will-change-transform w-full"
          style={{
...
type HighlightColor = "red" | "purple" | "green" | "accent";

interface HighlightProps extends React.HTMLAttributes<HTMLSpanElement> {
  /** Color preset. Default "accent". */
